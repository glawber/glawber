...
* [cite_start]**Containers & CI/CD:** Docker, Kubernetes (EKS/AKS), GitHub/GitLab CI e Jenkins[cite: 24, 44, 51].

## 💼 Experiência Profissional

### **DocPlanner (Feegow Technologies)** *Analista Cloud/DevOps Especialista AWS* | [cite_start]09/2022 – Atual [cite: 39, 40]
* [cite_start]Arquitetura de soluções em AWS com foco em segurança, escalabilidade e performance[cite: 41, 46].
...
* Utilização de ferramentas de **IA (Cursor e Claude)** para otimizar a criação de módulos Terraform e automação de rotinas.
* [cite_start]Liderança de iniciativas de **FinOps**, garantindo a eficiência financeira e redução de custos operacionais[cite: 45].

### **Itera Inteligência Artificial** *Engineer DevOps & Infraestrutura* | [cite_start]10/2021 – 08/2022 [cite: 48, 49]
* [cite_start]**Resultado:** Redução de **40% nos custos de cloud** através de padronização de automações[cite: 53].
...
* [cite_start]Liderança de equipe de suporte crítico e implantação de soluções baseadas em ITIL e metodologias ágeis[cite: 63, 64].
...
* [cite_start]**Linux Kubernetes & DevOps Essentials** – 4Linux[cite: 71, 72].
